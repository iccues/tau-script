use analyzer::token::{comment::Comment, identifier::Identifier, keyword::Keyword, number::{Float, Integer}, operator::Operator, singleton_token::EofToken, string::StringToken};
use analyzer::lexer::get_lexer;
